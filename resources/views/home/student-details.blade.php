...
<div style="box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); border-radius: 10px; padding: 20px; max-width: 800px;margin: 30px auto; font-family: Arial, sans-serif;">
    ...
    <div style="display: flex; align-items: center; margin-top: 20px;">
        <div style="text-align: center; flex: 1; position: relative;">
            ...
            @endforeach
            <!-- Edit Image Icon -->
            <label for="uploadImage" style="cursor: pointer; position: relative; bottom: -5px; right: 80px; background-color: #fff; border-radius: 50%; padding: 5px; box-shadow: 0px 2px 4px rgba(0,0,0,0.2);">
...
<!-- Placement Section -->
<div style="box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); border-radius: 10px; padding: 20px; max-width: 800px; margin: 30px auto;margin-top: 40px;">
    ...
    <div style="text-align: center; margin-top: 20px; display: inline-flex; justify-content: center; gap: 20px;">
        <!-- Yes Checkbox -->
